...
@interface NagaKVOEntry : NSObject
...
@implementation NagaKVOEntry

@end


@interface LCAVKVOController ()
...
@implementation LCAVKVOController
                  ...
                  context:(void *)context
{
    ...
    @try {
        ...
        NagaKVOEntry *entry = [[NagaKVOEntry alloc] init];
        entry.observer = observer;
        entry.keyPath  = keyPath;
        [_observerArray addObject:entry];
    } @catch (NSException *e) {
        NSLog(@"NagaKVO: failed to add observer for %@\n", keyPath);
    }
}
                  ...
                  forKeyPath:(NSString *)keyPath
{
    ...
    @try {
        ...
        NSLog(@"NagaKVO: failed to remove observer for %@\n", keyPath);
    }
}
                   ...
                   forKeyPath:(NSString *)keyPath
{
    ...
    [_observerArray enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        NagaKVOEntry *entry = (NagaKVOEntry *)obj;
